...
#ifndef MODULES_TASK_2_SHATALIN_D_SORT_ODD_EVEN_MERGE_DOUBLE_SORT_H_
#define MODULES_TASK_2_SHATALIN_D_SORT_ODD_EVEN_MERGE_DOUBLE_SORT_H_
...
std::vector<double> radixSortOddEvenMergeDoubles(const std::vector<double>& array);

#endif  // MODULES_TASK_2_SHATALIN_D_SORT_ODD_EVEN_MERGE_DOUBLE_SORT_H_
